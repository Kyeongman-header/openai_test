...
PATH = './second_level/'+'all_rake_before_crossattention.tar'
writer = SummaryWriter("./runs/before_crossattention/")
...
f = open('rake_before_second_level_val_results.csv','w', newline='')
wr = csv.writer(f)
