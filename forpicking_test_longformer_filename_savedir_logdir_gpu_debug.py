...
min_false_nonlast_score=[]
min_false_nonlast_text=[]
...
for line in rdr:
    ...
    if 'nextsentence' in save_dir : # nextsentenceprediction은 아예 다른 방식이다
        ...
        if keywords==last_keywords and para_count<(PARA-1):
            ...
            for_picking_accum_fake_score+=f_score.item()
            ...
            if step<10:
                ...
                if True in (for_picking_accum_fake_score>np.array(max_false_score)):
...
if len(min_false_nonlast_score)==0:
    ...
    print(max_false_nonlast_score)
    print("texts")
    for text in max_false_nonlast_text:
        print("-------------------------------------------------------------------------------------")
        print("#####################################################################################")
        print("-------------------------------------------------------------------------------------")
        print()
